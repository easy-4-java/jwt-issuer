...
```groovy
implementation 'io.github.easy4j:jwt-issuer-with-jjwt:2.0.x.x.20260630-SNAPSHOT'
implementation 'io.github.easy4j:jwt-issuer-with-nimbus:2.0.x.x.20260630-SNAPSHOT'
```
...
All modules share one version (`2.0.x.x.20260630-SNAPSHOT` on this branch). Releases are cut via GitHub Releases; Maven Central publication is planned but has not happened yet.
